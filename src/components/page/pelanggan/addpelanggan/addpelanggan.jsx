...
const AddPelanggan = () => {
    ...
    return (
        <div className="content">
            ...
            <form action="" onSubmit={addGan} className="flex flex-col">
                <div className="nama-produk">
                    ...
                    <input 
                        ...
                        name="nama" 
                        id="namaProduk" 
                        placeholder="Masukkan Nama Pelangan" 
                ...
                <div className="sub">
                    <button type="submit" className="w-full text-center bg-green-500 rounded-md py-1 my-2">Submit</button>
                </div>
            </form>
        </div>
    )
